...
#
# vivado-project.tcl: Tcl script for re-creating project 'vivado-project'
#
# Generated by Vivado on Mon Jul 07 01:31:16 -0400 2025
...
#
# 1. This project restoration tcl script (vivado-project.tcl) that was generated.
#
...
#
#    "D:/AMD/Projects/risc-v-processor-fpga/srcs/alu.v"
#    "D:/AMD/Projects/risc-v-processor-fpga/srcs/instruction_decoder.v"
#    "D:/AMD/Projects/risc-v-processor-fpga/srcs/core.v"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../instruction_decoder.v"]"\
 "[file normalize "$origin_dir/../core.v"]"\
 "[file normalize "$origin_dir/core_tb.v"]"\
 "[file normalize "$origin_dir/alu_tb.v"]"\
 "[file normalize "$origin_dir/register_tb.v"]"\
  ]
  foreach ifile $files {
    if { ![file isfile $ifile] } {
...
set script_file "vivado-project.tcl"
...
set file "$origin_dir/../instruction_decoder.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "$origin_dir/register_tb.v"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
...
set file "new/instruction_decoder_tb.v"
set file_obj [get_files -of_objects [get_filesets sim_1] [list "*$file"]]
set_property -name "file_type" -value "Verilog" -objects $file_obj
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
